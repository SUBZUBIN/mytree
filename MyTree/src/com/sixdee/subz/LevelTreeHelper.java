 ...
 *
 */
class LevelTreeHelper {
	public <Node, Node2> boolean isEqual(LevelTree<Node> testTree, LevelTree<Node2> thisTree, Node testNode, Node2 thisNode) throws NodeNotFoundException {
	 ...
	 */
	public <Node> boolean isAncestor(LevelTree<Node> tree, Node node, Node child) throws NodeNotFoundException {
	 ...
	 */
	public <Node> boolean isDescendant(LevelTree<Node> tree, Node parent, Node node) throws NodeNotFoundException {
	 ...
	 * */
	public <Node> Node commonAncestor(LevelTree<Node> tree, Node node1, Node node2) throws NodeNotFoundException {
		int height1 = 0;
		Node e1 = node1;
		while (e1 != null) {
			height1++;
